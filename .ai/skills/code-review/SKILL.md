...
1. Do not approve changes that silently alter public contract surfaces (see AGENTS.md)
...
1. Check each package against its own `AGENTS.md` guide
2. Verify contract surfaces at package boundaries
3. Check that codegen inputs/outputs are consistent
4. Flag any missing spec (see "When A Spec Is Required" in root AGENTS.md)
