  ...
  return (
    <div>
      <h1>
				...
				The support team at Mercur has cancelled your order for {data.order.item}. You will receive a full refund.
      </h1>
      <p>
				If you have any questions, please contact Mercur Support.
      </p>
			<p>
