...
export class Migration20241213115114 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table if not exists "payout_account" ("id" text not null, "status" text check ("status" in (\'pending\', \'active\', \'disabled\')) not null default \'pending\', "reference_id" text null, "data" jsonb null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "payout_account_pkey" primary key ("id"));');
