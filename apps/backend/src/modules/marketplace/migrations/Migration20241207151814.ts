...
export class Migration20241207151814 extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('create table if not exists "order_set" ("id" text not null, "display_id" integer null, "sales_channel_id" text not null, "cart_id" text not null, "customer_id" text null, "payment_collection_id" text not null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "order_set_pkey" primary key ("id"));');
