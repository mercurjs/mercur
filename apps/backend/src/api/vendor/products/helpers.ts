...
import { VendorBatchVariantInventoryItemsType } from "./validators"
...
export const buildBatchVariantInventoryData = (
  inputs:
    | VendorBatchVariantInventoryItemsType["create"]
    | VendorBatchVariantInventoryItemsType["update"]
    | VendorBatchVariantInventoryItemsType["delete"]
) => {
