...
<Steps>
  <Step title="Create the project">
    Condensed link back to [Installation](/learn/introduction).
  </Step>
...
<CardGroup cols={2}>
  <Card title="Add a feature with a block" href="/resources/tutorials/add-a-block" />
  <Card title="Commissions" href="/platform/commission/overview" />
</CardGroup>
