...
Use Mercur to decide what share of each sale the marketplace keeps and each
seller earns.

The Commission domain is the marketplace's revenue engine. You define **rates**
(fixed or percentage) and scope them to parts of your catalog with **rules**.
Mercur resolves the right rate for every order line and writes a **commission
line**. That line is the exact amount deducted before the seller is paid out.
