...
Use Mercur to onboard, govern, and operate the sellers on your marketplace.

The Store domain is the foundation the rest of the marketplace builds on. Every
offer, order, payout, and storefront page belongs to a store. A store carries its
own team, a governed account lifecycle, and the business details used to settle
payouts. All of it is exposed directly through the Admin and Vendor APIs.
...
- **Multi-user teams:** many-to-many members, roles, and a store switcher for users who belong to several stores.
