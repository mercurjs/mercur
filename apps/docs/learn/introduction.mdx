...
<Frame caption="A quick walkthrough of the operator and seller panels.">
  <video
    autoPlay
    muted
    loop
...
<Frame caption="The Admin Panel Orders view. Each row is an order group, and a multi-vendor cart splits into per-seller orders across one or more stores.">
