...
See [Concepts](/rc/learn/concepts) and [Architecture](/rc/learn/architecture) for the full picture, or jump straight to [Installation](/learn/introduction) to spin up a marketplace locally.
...
Then head to the [Installation guide](/learn/introduction) to run it locally, or [talk to our team](https://www.mercurjs.com/contact) if you're migrating from an existing platform.
