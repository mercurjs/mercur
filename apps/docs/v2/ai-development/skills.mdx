...
Every Mercur project created with `mercurjs create` includes a set of **skills** — reusable prompt modules that teach your AI coding tool how to work with Mercur correctly.
