...
description: What changed in Mercur 2.1.0 and how to upgrade an existing 2.0.x project.
---

# Migrating from 2.0 to 2.1

Mercur `2.1.0` is the first stable release of the 2.x line after `2.0.2`. The only required change is a package rename. Everything else is handled by `bun run medusa db:migrate`.

If you are starting fresh, follow [Installation](/v2/getting-started/installation) instead — new projects already use the 2.1 names.
...
The complete 2.1.0 changelog is published with the [GitHub release](https://github.com/mercurjs/mercur/releases/tag/v2.1.0).
