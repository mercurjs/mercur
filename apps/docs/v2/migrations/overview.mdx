...
- [From 2.0 to 2.1](/v2/migrations/from-2-0-to-2-1) — package rename (`@mercurjs/core-plugin` → `@mercurjs/core`) and a `db:migrate` step
- [From 1.x to 2.0](/v2/migrations/from-1-x-to-2-0) — full guide for porting an existing 1.x project