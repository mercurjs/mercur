...
The CLI (`@mercurjs/cli@canary`) manages this process: scaffolding projects, installing blocks, searching the registry, and comparing local changes against upstream versions.
