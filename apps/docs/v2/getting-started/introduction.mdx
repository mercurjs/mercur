...
<Warning>
Mercur 2.0 is a new architecture, not a drop-in upgrade from 1.x. Most migration paths are covered, but `TaxCode`, `SecondaryCategory`, and the 1.x product attribute system currently require extra migration work. See [From 1.x to 2.0](/v2/migrations/from-1-x-to-2-0).
</Warning>
