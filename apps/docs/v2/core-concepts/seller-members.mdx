...
- Members are managed through the [seller account lifecycle](/v2/core-concepts/seller) — if a seller is terminated, all member associations are effectively void
