...
- A running Mercur project ([installation guide](/getting-started/installation))
- Node.js 20+
...
For more details on payout accounts, balances, and transactions, see [Payout](/core-concepts/payout).
