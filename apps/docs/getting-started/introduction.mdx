...
- **[LLMs](/ai-development/llms)** — Feed the full Mercur documentation to any LLM via `llms.txt`
- **[MCP Server](/ai-development/mcp)** — Let your AI tool search Mercur docs in real time (Cursor, VS Code, Claude, Claude Code)
- **[Skills](/ai-development/skills)** — Pre-built AI workflows that ship with every Mercur project for guided development
