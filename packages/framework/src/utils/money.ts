...
/**
 * *
 * This function determines multiplier for specified currency
 * 
 * @param {any} currency - ISO currency code for conversion scaling
 * @returns {number} Determines the conversion rate based on the specified currency code.
