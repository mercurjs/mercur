...
>(({ form }, ref) => {
  ...
  const validateAttributes = async () => {
    ...
    const optionsValid =
      currentOptions.length > 0 ? await form.trigger("options") : true;
      ...
      <div className="flex items-start justify-between">
        <div className="flex flex-col gap-y-2">
          ...
          <div className="space-y-0.5">
            <Text size="small" className="max-w-[440px] text-ui-fg-subtle">
            ...
            >
              ...
              <Tooltip
                content={t("products.create.attributes.learnMore.content")}
              >
                <CircleInfoSolid />
              </Tooltip>
            </Text>
