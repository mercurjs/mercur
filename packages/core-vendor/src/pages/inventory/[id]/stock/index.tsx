...
export const Component = () => {
  ...
  const { stock_locations, isPending: isPendingStockLocations, isError: isErrorStockLocations, error: errorStockLocations } = useStockLocations({ limit: 9999, fields: "id,name" })
  ...
  return (
    <RouteFocusModal>
      ...
      {ready && <InventoryStockForm items={inventory_items} locations={stock_locations} />}
    </RouteFocusModal>
  )
}
