...
export const Breadcrumb = (props: CustomerDetailBreadcrumbProps) => {
  ...
  const { customer } = useCustomer(id!, undefined, { initialData: props.data, enabled: Boolean(id) })
...
export const Component = () => {
  ...
  const { customer, isLoading, isError, error } = useCustomer(id!, { fields: "*groups, *groups.customers" }, { initialData })
