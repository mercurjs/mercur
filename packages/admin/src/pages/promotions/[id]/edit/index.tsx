...
import { EditPromotionDetailsForm } from "../../promotion-edit-details/components/edit-promotion-form"

const PromotionEditDetails = () => {
  const { id } = useParams()
...
export const Component = PromotionEditDetails
