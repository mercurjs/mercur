...
export const CreateShippingOptionTypeForm = () => {
  ...
  return (
    <RouteFocusModal.Form
      form={form}
      data-testid="shipping-option-type-create-form"
    >
      <KeyboundForm onSubmit={handleSubmit} className="flex h-full flex-col">
        <RouteFocusModal.Body
          className="flex flex-col items-center overflow-auto p-16"
          data-testid="shipping-option-type-create-form-body"
        >
          <div className="flex w-full max-w-[720px] flex-col gap-y-8">
            <div data-testid="shipping-option-type-create-form-header-section">
              <Heading data-testid="shipping-option-type-create-form-heading">
                {t("shippingOptionTypes.create.header")}
              </Heading>
              <Text
                size="small"
                className="text-ui-fg-subtle"
                data-testid="shipping-option-type-create-form-hint"
              >
                  ...
                  return (
                    <Form.Item data-testid="shipping-option-type-create-form-code-item">
                      ...
                      <Form.Control data-testid="shipping-option-type-create-form-code-control">
                        <Input
                          {...field}
                          data-testid="shipping-option-type-create-form-code-input"
                        />
                      </Form.Control>
                  ...
                  return (
                    <Form.Item data-testid="shipping-option-type-create-form-description-item">
                      ...
                      <Form.Control data-testid="shipping-option-type-create-form-description-control">
                        <Input
                          {...field}
                          data-testid="shipping-option-type-create-form-description-input"
                        />
                      </Form.Control>
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteFocusModal.Close asChild>
              <Button
                size="small"
                variant="secondary"
                data-testid="shipping-option-type-create-form-cancel-button"
              >
                {t("actions.cancel")}
              </Button>
