      ...
      >
        ...
        >
          <RouteFocusModal.Header
            data-testid={`${keyType}-api-key-create-header`}
          />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Form.Field
                    ...
                    render={({ field }) => {
                      return (
                        <Form.Item
                          data-testid={`${keyType}-api-key-create-title-item`}
                        >
                          <Form.Label
                            data-testid={`${keyType}-api-key-create-title-label`}
                          >
                            {t("fields.title")}
                          </Form.Label>
                          <Form.Control
                            data-testid={`${keyType}-api-key-create-title-control`}
                          >
                            <Input
                              {...field}
          ...
          <RouteFocusModal.Footer
            data-testid={`${keyType}-api-key-create-footer`}
          >
