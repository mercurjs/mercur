                ...
                <Form.Control data-testid="location-shipping-option-create-details-form-price-type-control">
                  ...
                  >
                    <RadioGroup.ChoiceBox
                      ...
                      label={t("stockLocations.shippingOptions.fields.priceType.options.fixed.label")}
                      description={t("stockLocations.shippingOptions.fields.priceType.options.fixed.hint")}
                      data-testid="location-shipping-option-create-details-form-price-type-flat-rate"
                    />
                    <RadioGroup.ChoiceBox
                      className="flex-1"
                      value={ShippingOptionPriceType.Calculated}
                      label={t("stockLocations.shippingOptions.fields.priceType.options.calculated.label")}
                      description={t("stockLocations.shippingOptions.fields.priceType.options.calculated.hint")}
...
Root._tabMeta = defineTabMeta<CreateShippingOptionSchema>({
  id: "details",
  labelKey: "stockLocations.shippingOptions.create.tabs.details",
  validationFields: [
