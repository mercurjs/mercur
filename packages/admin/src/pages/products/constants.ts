 ...
 */
export const PRODUCT_DETAIL_FIELDS = "*categories,-variants,*variant_attributes,*variant_attributes.values,*custom_attributes,*custom_attributes.values,*attribute_values,*attribute_values.attribute"
