...
export const REGISTRY_SCHEMA_URL = "http://registry.mercurjs.com/registry.json";
export const REGISTRY_ITEM_SCHEMA_URL = "http://registry.mercurjs.com/registry-item.json";
