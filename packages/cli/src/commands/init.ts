...
async function promptForMinimalConfig(
  ...
  return rawConfigSchema.parse({
    ...
    aliases: {
      ...
      vendorPages: options.vendorPages ?? existingConfig.aliases.vendorPages,
      adminPages: options.adminPages ?? existingConfig.aliases.adminPages,
