...
/**
 * @oas [get] /vendor/product-categories/{id}/products
 * operationId: "VendorListProductCategoryProducts"
 * summary: "List products in category"
 * description: "Retrieves a list of products belonging to a specific category for the current seller."
