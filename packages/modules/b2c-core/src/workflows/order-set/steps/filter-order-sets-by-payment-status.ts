...
export const filterOrderSetsByPaymentStatusStep = createStep(
  "filter-order-sets-by-payment-status",
  async (input: { paymentStatuses: string[] }, { container }) => {
    ...
    const orderSetIds = await filterHelper.handlePaymentStatusFilter(
