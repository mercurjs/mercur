 ...
 */
import type { AdminPostCampaignsBodyAllOfBudgetType } from './adminPostCampaignsBodyAllOfBudgetType';

/**
 * The campaign's budget which, when crossed, ends the campaign.
 */
export type AdminPostCampaignsBodyAllOfBudget = {
 ...
 */
  type: AdminPostCampaignsBodyAllOfBudgetType;
};
