 ...
 */
import type { BaseOrderShippingMethodTaxLineShippingMethod } from './baseOrderShippingMethodTaxLineShippingMethod';
...
export interface BaseOrderShippingMethodTaxLine {
  ...
  /** The rate to charge. */
  rate: number;
  shipping_method: BaseOrderShippingMethodTaxLineShippingMethod;
