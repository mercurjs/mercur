 ...
 */
import type { AdminPostCustomersIdAddressesAddressIdBodyAllOfMetadata } from './adminPostCustomersIdAddressesAddressIdBodyAllOfMetadata';

/**
 * The address's details.
 */
export type AdminPostCustomersIdAddressesAddressIdBodyAllOf = {
  ...
  metadata: AdminPostCustomersIdAddressesAddressIdBodyAllOfMetadata;
  /** The address's phone. */
  phone: string;
