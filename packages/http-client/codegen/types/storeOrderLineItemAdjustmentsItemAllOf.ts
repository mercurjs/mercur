 ...
 */
import type { StoreOrderLineItemAdjustmentsItemAllOfItem } from './storeOrderLineItemAdjustmentsItemAllOfItem';

/**
 * The adjustment's adjustments.
 */
export type StoreOrderLineItemAdjustmentsItemAllOf = {
  ...
  item: StoreOrderLineItemAdjustmentsItemAllOfItem;
