 ...
 */
import type { OrderShippingMethodAdjustmentShippingMethod } from './orderShippingMethodAdjustmentShippingMethod';
...
export interface OrderShippingMethodAdjustment {
  ...
  provider_id?: string;
  shipping_method: OrderShippingMethodAdjustmentShippingMethod;
