...
import type { AdminOrderLineItemDetail } from './adminOrderLineItemDetail';
import type { AdminOrderLineItemMetadata } from './adminOrderLineItemMetadata';
...
import type { AdminOrderLineItemVariantOptionValues } from './adminOrderLineItemVariantOptionValues';
...
export interface AdminOrderLineItem {
  ...
  created_at: string;
  detail: AdminOrderLineItemDetail;
  ...
  metadata: AdminOrderLineItemMetadata;
  /** The item's total excluding taxes, including promotions. */
  ...
  variant_option_values: AdminOrderLineItemVariantOptionValues;
