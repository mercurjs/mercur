 ...
 */
import type { StoreOrderFulfillmentData } from './storeOrderFulfillmentData';
import type { StoreOrderFulfillmentMetadata } from './storeOrderFulfillmentMetadata';
...
export interface StoreOrderFulfillment {
  ...
  data: StoreOrderFulfillmentData;
  ...
  metadata: StoreOrderFulfillmentMetadata;
