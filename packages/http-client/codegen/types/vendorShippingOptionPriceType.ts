 ...
 */
export type VendorShippingOptionPriceType = typeof VendorShippingOptionPriceType[keyof typeof VendorShippingOptionPriceType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const VendorShippingOptionPriceType = {
