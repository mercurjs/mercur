 ...
 */
import type { StoreOrderLineItemDetailAllOfItemAdjustmentsItemAllOfItem } from './storeOrderLineItemDetailAllOfItemAdjustmentsItemAllOfItem';

/**
 * The adjustment's adjustments.
 */
export type StoreOrderLineItemDetailAllOfItemAdjustmentsItemAllOf = {
  ...
  item: StoreOrderLineItemDetailAllOfItemAdjustmentsItemAllOfItem;
