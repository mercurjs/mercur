...
import type { BaseOrderFulfillmentStatus } from './baseOrderFulfillmentStatus';
import type { BaseOrderFulfillment } from './baseOrderFulfillment';
import type { BaseOrderLineItem } from './baseOrderLineItem';
import type { BaseOrderMetadata } from './baseOrderMetadata';
import type { BasePaymentCollection } from './basePaymentCollection';
import type { BaseOrderPaymentStatus } from './baseOrderPaymentStatus';
...
export interface BaseOrder {
  ...
  fulfillment_status: BaseOrderFulfillmentStatus;
  ...
  payment_status: BaseOrderPaymentStatus;
