 ...
 */
import type { AdminCreatePromotionRuleOperator } from './adminCreatePromotionRuleOperator';
import type { AdminCreatePromotionRuleValues } from './adminCreatePromotionRuleValues';
...
export interface AdminCreatePromotionRule {
  ...
  operator: AdminCreatePromotionRuleOperator;
