 ...
 */
import type { VendorOrderLineItemDetail } from './vendorOrderLineItemDetail';
import type { VendorOrderLineItemMetadata } from './vendorOrderLineItemMetadata';
import type { VendorProduct } from './vendorProduct';
import type { VendorProductVariant } from './vendorProductVariant';
import type { VendorOrderLineItemVariantOptionValues } from './vendorOrderLineItemVariantOptionValues';
...
export interface VendorOrderLineItem {
  ...
  created_at?: string;
  detail?: VendorOrderLineItemDetail;
  ...
  metadata?: VendorOrderLineItemMetadata;
  /** The item's total excluding taxes, including promotions. */
  ...
  variant_option_values?: VendorOrderLineItemVariantOptionValues;
