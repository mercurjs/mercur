 ...
 */
export type AdminPostCampaignsBodyAllOfBudgetType = typeof AdminPostCampaignsBodyAllOfBudgetType[keyof typeof AdminPostCampaignsBodyAllOfBudgetType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AdminPostCampaignsBodyAllOfBudgetType = {
  spend: 'spend',
  usage: 'usage',
} as const;
