 ...
 */
import type { StoreOrderLineItemTaxLinesItemAllOfItemAdjustmentsItemItem } from './storeOrderLineItemTaxLinesItemAllOfItemAdjustmentsItemItem';

/**
 * The adjustment's adjustments.
 */
export type StoreOrderLineItemTaxLinesItemAllOfItemAdjustmentsItem = {
  ...
  item: StoreOrderLineItemTaxLinesItemAllOfItemAdjustmentsItemItem;
