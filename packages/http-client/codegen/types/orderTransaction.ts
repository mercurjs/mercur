 ...
 */
import type { OrderTransactionMetadata } from './orderTransactionMetadata';
import type { OrderTransactionOrder } from './orderTransactionOrder';
import type { OrderTransactionReference } from './orderTransactionReference';
...
export interface OrderTransaction {
  ...
  metadata: OrderTransactionMetadata;
  order: OrderTransactionOrder;
  ...
  reference: OrderTransactionReference;
