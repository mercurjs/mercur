 ...
 */
import type { AdminOrderFulfillmentData } from './adminOrderFulfillmentData';
import type { AdminOrderFulfillmentMetadata } from './adminOrderFulfillmentMetadata';
...
export interface AdminOrderFulfillment {
  ...
  data: AdminOrderFulfillmentData;
  ...
  metadata: AdminOrderFulfillmentMetadata;
