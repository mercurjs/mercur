 ...
 */
import type { StoreOrderShippingMethodAdjustmentsItemAllOfShippingMethod } from './storeOrderShippingMethodAdjustmentsItemAllOfShippingMethod';

/**
 * The adjustment's adjustments.
 */
export type StoreOrderShippingMethodAdjustmentsItemAllOf = {
  ...
  shipping_method: StoreOrderShippingMethodAdjustmentsItemAllOfShippingMethod;
