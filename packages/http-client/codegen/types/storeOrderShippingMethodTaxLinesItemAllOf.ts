 ...
 */
import type { StoreOrderShippingMethodTaxLinesItemAllOfShippingMethod } from './storeOrderShippingMethodTaxLinesItemAllOfShippingMethod';

/**
 * The tax line's tax lines.
 */
export type StoreOrderShippingMethodTaxLinesItemAllOf = {
  /** The tax line's code. */
  code: string;
  ...
  shipping_method: StoreOrderShippingMethodTaxLinesItemAllOfShippingMethod;
