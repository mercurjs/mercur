 ...
 * The applied action.
 */
export type AdminOrderChangeActionAction = typeof AdminOrderChangeActionAction[keyof typeof AdminOrderChangeActionAction];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AdminOrderChangeActionAction = {
