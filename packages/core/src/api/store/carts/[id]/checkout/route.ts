...
import { StoreCheckoutCartParamsType } from "./validators"

export const POST = async (
    req: MedusaRequest<{}, StoreCheckoutCartParamsType>,
    ...
    const { data: orderGroups } = await query.graph({
        entity: "order_group",
        fields: req.queryConfig?.fields ?? defaultStoreRetrieveOrderGroupFields,
