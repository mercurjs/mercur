...
import sellerAttributeValueLink from "../../../links/seller-attribute-value-link"
import { deleteAttributeValueWorkflow } from "./delete-attribute-value"

export const convertAttributeToOptionWorkflowId =
  "convert-attribute-to-option"
...
export const convertAttributeToOptionWorkflow: ReturnType<typeof createWorkflow> = createWorkflow(
