import { useAdminOrders, useAdminProducts } from "medusa-react";
...
const SearchModal = ({ handleClose }) => {
  ...
  const isFetching = isFetchingProducts || isFetchingOrders;

  const totalLength = getTotal(products, orders);
