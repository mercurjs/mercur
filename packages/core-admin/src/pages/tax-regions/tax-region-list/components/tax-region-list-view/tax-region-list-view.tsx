...
import { TaxRegionTable } from "@pages/tax-regions/common/components/tax-region-table";
import { useTaxRegionTable } from "@pages/tax-regions/common/hooks/use-tax-region-table";
