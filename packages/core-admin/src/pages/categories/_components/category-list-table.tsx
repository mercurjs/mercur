...
import { useDeleteProductCategoryAction } from "@pages/categories/common/hooks/use-delete-product-category-action"
...
export interface CategoryListTableProps {
   ...
   * Use `useCategoryTableColumns()` as base and extend it.
   */
  columns?: ColumnDef<HttpTypes.AdminProductCategory, any>[]
}

export const CategoryListTable = ({ columns: customColumns }: CategoryListTableProps = {}) => {
