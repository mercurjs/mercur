...
import { AddCampaignPromotionForm } from "../../promotion-add-campaign/components/add-campaign-promotion-form"

const PromotionAddCampaign = () => {
  const { id } = useParams()
...
export const Component = PromotionAddCampaign
