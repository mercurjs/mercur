...
import { useDeleteApiKey, useRevokeApiKey } from "@hooks/api/api-keys"
...
export const ApiKeyGeneralSection = ({ apiKey }: ApiKeyGeneralSectionProps) => {
  ...
  return (
    <Container
      ...
      data-testid={`${apiKey.type}-api-key-general-section`}
    >
      <div
        className="flex items-center justify-between px-6 py-4"
        data-testid={`${apiKey.type}-api-key-general-section-header`}
      >
        <Heading data-testid={`${apiKey.type}-api-key-general-section-heading`}>
          {apiKey.title}
        </Heading>
        <div
          className="flex items-center gap-x-4"
          data-testid={`${apiKey.type}-api-key-general-section-actions`}
        >
          <div
            className="flex items-center gap-x-2"
            data-testid={`${apiKey.type}-api-key-general-section-status`}
          >
            <StatusBadge
              color={apiKeyStatus.color}
              data-testid={`${apiKey.type}-api-key-general-section-status-badge`}
            >
              {apiKeyStatus.label}
            </StatusBadge>
          </div>
      ...
      <div
        ...
        data-testid={`${apiKey.type}-api-key-general-section-key-row`}
      >
        <Text
          size="small"
          leading="compact"
          weight="plus"
          data-testid={`${apiKey.type}-api-key-general-section-key-label`}
        >
          {t("fields.key")}
        </Text>
        {apiKey.type === "secret" ? (
          <Badge
            ...
            data-testid={`${apiKey.type}-api-key-general-section-key-badge`}
          >
          ...
          <Copy
            ...
            data-testid={`${apiKey.type}-api-key-general-section-key-copy`}
          >
            <Badge
              size="2xsmall"
      ...
      <div
        className="text-ui-fg-subtle grid grid-cols-2 items-center px-6 py-4"
        data-testid={`${apiKey.type}-api-key-general-section-type-row`}
      >
        <Text
          size="small"
          leading="compact"
          weight="plus"
          data-testid={`${apiKey.type}-api-key-general-section-type-label`}
        >
          {t("fields.type")}
        </Text>
        <Text
          size="small"
          leading="compact"
          data-testid={`${apiKey.type}-api-key-general-section-type-value`}
        >
          {apiKeyType.label}
        </Text>
      </div>
      <div
        className="text-ui-fg-subtle grid grid-cols-2 items-center px-6 py-4"
        data-testid={`${apiKey.type}-api-key-general-section-last-used-row`}
      >
        <Text
          size="small"
          leading="compact"
          weight="plus"
          data-testid={`${apiKey.type}-api-key-general-section-last-used-label`}
        >
        ...
        <Text
          size="small"
          leading="compact"
          data-testid={`${apiKey.type}-api-key-general-section-last-used-value`}
        >
          {apiKey.last_used_at
      ...
      <div
        className="text-ui-fg-subtle grid grid-cols-2 items-center px-6 py-4"
        data-testid={`${apiKey.type}-api-key-general-section-created-by-row`}
      >
        <Text
          size="small"
          leading="compact"
          weight="plus"
          data-testid={`${apiKey.type}-api-key-general-section-created-by-label`}
        >
          {t("apiKeyManagement.fields.createdByLabel")}
        </Text>
        <ActionBy
          userId={apiKey.created_by}
          data-testid={`${apiKey.type}-api-key-general-section-created-by-value`}
        />
      </div>
      {apiKey.revoked_at && (
        <>
          <div
            className="text-ui-fg-subtle grid grid-cols-2 items-center px-6 py-4"
            data-testid={`${apiKey.type}-api-key-general-section-revoked-at-row`}
          >
            <Text
              size="small"
              leading="compact"
              weight="plus"
              data-testid={`${apiKey.type}-api-key-general-section-revoked-at-label`}
            >
            ...
            <Text
              size="small"
              leading="compact"
              data-testid={`${apiKey.type}-api-key-general-section-revoked-at-value`}
            >
          ...
          <div
            className="text-ui-fg-subtle grid grid-cols-2 items-center px-6 py-4"
            data-testid={`${apiKey.type}-api-key-general-section-revoked-by-row`}
          >
            <Text
              size="small"
              leading="compact"
              weight="plus"
              data-testid={`${apiKey.type}-api-key-general-section-revoked-by-label`}
            >
              {t("apiKeyManagement.fields.revokedByLabel")}
            </Text>
            <ActionBy
              userId={apiKey.revoked_by}
              data-testid={`${apiKey.type}-api-key-general-section-revoked-by-value`}
            />
          </div>
        </>
      )}
