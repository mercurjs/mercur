...
import { ApiKeySalesChannelsForm } from "./_components/api-key-sales-channels-form"

const ApiKeyManagementAddSalesChannels = () => {
  const { id } = useParams()
...
export const Component = ApiKeyManagementAddSalesChannels
