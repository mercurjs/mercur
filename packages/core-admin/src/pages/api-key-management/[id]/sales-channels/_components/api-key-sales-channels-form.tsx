...
export const ApiKeySalesChannelsForm = ({
  ...
  return (
    <RouteFocusModal.Form
      form={form}
      data-testid="publishable-api-key-sales-channels-form"
    >
      <KeyboundForm onSubmit={handleSubmit} className="flex h-full flex-col">
        <RouteFocusModal.Header data-testid="publishable-api-key-sales-channels-form-header">
          ...
          <div
            ...
            data-testid="publishable-api-key-sales-channels-form-error-container"
          >
            {form.formState.errors.sales_channel_ids && (
              <Hint
                variant="error"
                data-testid="publishable-api-key-sales-channels-form-error"
              >
        ...
        <RouteFocusModal.Body
          ...
          data-testid="publishable-api-key-sales-channels-form-body"
        >
          <DataTable
            data={sales_channels}
            columns={columns}
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteFocusModal.Close asChild>
              <Button
                size="small"
                variant="secondary"
                data-testid="publishable-api-key-sales-channels-form-cancel-button"
              >
                {t("actions.cancel")}
              </Button>
            ...
            <Button
              ...
              data-testid="publishable-api-key-sales-channels-form-save-button"
            >
              {t("actions.save")}
            </Button>
          </div>
