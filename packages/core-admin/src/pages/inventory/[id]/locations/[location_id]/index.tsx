...
import { AdjustInventoryForm } from "@pages/inventory/inventory-detail/components/adjust-inventory/components/adjust-inventory-form"

const AdjustInventoryDrawer = () => {
...
export const Component = AdjustInventoryDrawer
