...
} from "@pages/workflow-executions/_common/utils"
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Heading data-testid="workflow-execution-general-section-heading">
            {cleanId}
          </Heading>
          <Copy
            content={cleanId}
      ...
      >
        {actionableSteps.map((step) => (
          <div
            key={step.id}
            className={clx(
              "shadow-details-switch-background h-3 w-1.5 rounded-full bg-ui-bg-switch-off",
              {
                "bg-ui-fg-muted":
