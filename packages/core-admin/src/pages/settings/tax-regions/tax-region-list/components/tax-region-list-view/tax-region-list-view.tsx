...
import { TaxRegionTable } from "@pages/settings/tax-regions/common/components/tax-region-table";
import { useTaxRegionTable } from "@pages/settings/tax-regions/common/hooks/use-tax-region-table";
