...
} from "@pages/settings/tax-regions/tax-region-tax-override-edit/components/tax-region-tax-override-edit-form"
import type { InitialRuleValues } from "@pages/settings/tax-regions/tax-region-tax-override-edit/types"
import type { ExtendedAdminTaxRate } from "@custom-types/tax-rates"

const TaxRegionProvinceTaxOverrideEdit = () => {
...
export const Component = TaxRegionProvinceTaxOverrideEdit
