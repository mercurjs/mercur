...
import { TaxRegionTaxRateEditForm } from "@pages/settings/tax-regions/tax-region-tax-rate-edit/components/tax-region-tax-rate-edit-form"

const TaxRegionProvinceTaxRateEdit = () => {
...
export const Component = TaxRegionProvinceTaxRateEdit
