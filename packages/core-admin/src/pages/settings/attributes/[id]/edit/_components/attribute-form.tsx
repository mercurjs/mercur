...
import PossibleValuesList from "@pages/settings/attributes/create/_components/possible-values-list"

import {
  AdminUpdateAttribute,
  CreateAttributeFormSchema,
} from "../_common/schema"
import { findDuplicatePossibleValues } from "../_common/utils"
      ...
      >
        ...
        {form.watch("ui_component") === AttributeUIComponent.SELECT && (
          <InlineTip label="Tip" variant="info">
            ...
            value. This type of attribute will be good for product
            specifications.
          </InlineTip>
        )}
