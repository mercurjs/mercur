...
import { PossibleValuesTable } from "@pages/settings/attributes/[id]/possible-values/_components/possible-values-table"
  ...
  return (
    <SingleColumnLayout>
      <Container className="divide-y p-0" data-testid="attribute-detail-container">
        ...
        >
          <Heading level="h2" data-testid="attribute-detail-heading">
            {attribute.name}
          </Heading>
          <div
...
export const Component = AttributeDetail
