...
export const UserListTable = () => {
  ...
  const { searchParams, raw } = useUserTableQuery({
    pageSize: PAGE_SIZE,
  } as { pageSize: number })
  ...
  return (
    <Container className="divide-y p-0" data-testid="users-list-table">
      <div
        className="flex items-center justify-between px-6 py-4"
        data-testid="users-list-header"
      >
        <Heading level="h2" data-testid="users-list-title">
          {t("users.domain")}
        </Heading>
        <Link to="invite" data-testid="users-invite-link">
          <Button
            size="small"
            variant="secondary"
    ...
    () => [
      columnHelper.accessor("email", {
        header: () => (
          ...
          >
            <span data-testid="users-table-header-email-text">
              {t("fields.email")}
            </span>
          </div>
        ),
      ...
      columnHelper.accessor("first_name", {
        header: () => (
          ...
          >
            <span data-testid="users-table-header-first_name-text">
              {t("fields.firstName")}
            </span>
          </div>
        ),
      ...
      columnHelper.accessor("last_name", {
        header: () => (
          ...
          >
            <span data-testid="users-table-header-last_name-text">
              {t("fields.lastName")}
            </span>
          </div>
        ),
      ...
      columnHelper.accessor("created_at", {
        header: () => (
          ...
          >
            <span data-testid="users-table-header-created_at-text">
              {t("fields.createdAt")}
            </span>
          </div>
        ),
      ...
      columnHelper.accessor("updated_at", {
        header: () => (
          ...
          >
            <span data-testid="users-table-header-updated_at-text">
              {t("fields.updatedAt")}
            </span>
          </div>
        ),
      ...
      columnHelper.display({
        ...
        cell: ({ row }) => {
          return <UserActions user={row.original} index={row.index} />
        },
      }),
    ],
    [t, navigate]
