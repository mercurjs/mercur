...
export const EditUserForm = ({ user }: EditUserFormProps) => {
  ...
  return (
    <RouteDrawer.Form form={form} data-testid="user-edit-form">
      ...
      >
        <RouteDrawer.Body
          className="flex max-w-full flex-1 flex-col gap-y-8 overflow-y-auto"
          data-testid="user-edit-form-body"
        >
          <Form.Field
            ...
            render={({ field }) => {
              return (
                <Form.Item data-testid="user-edit-form-first-name-item">
                  <Form.Label data-testid="user-edit-form-first-name-label">
                    {t("fields.firstName")}
                  </Form.Label>
                  <Form.Control data-testid="user-edit-form-first-name-control">
                    <Input
                      {...field}
                      data-testid="user-edit-form-first-name-input"
                    />
                  </Form.Control>
            ...
            render={({ field }) => {
              return (
                <Form.Item data-testid="user-edit-form-last-name-item">
                  <Form.Label data-testid="user-edit-form-last-name-label">
                    {t("fields.lastName")}
                  </Form.Label>
                  <Form.Control data-testid="user-edit-form-last-name-control">
                    <Input
                      {...field}
                      data-testid="user-edit-form-last-name-input"
                    />
                  </Form.Control>
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteDrawer.Close asChild>
              <Button
                size="small"
                variant="secondary"
                data-testid="user-edit-form-cancel-button"
              >
                {t("actions.cancel")}
              </Button>
            </RouteDrawer.Close>
            <Button
              ...
              type="submit"
              isLoading={isPending}
              data-testid="user-edit-form-save-button"
            >
              {t("actions.save")}
            </Button>
          </div>
