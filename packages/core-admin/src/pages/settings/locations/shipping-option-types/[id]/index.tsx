...
import { ShippingOptionTypeGeneralSection } from "./_components/shipping-option-type-general-section"
import { shippingOptionTypeLoader } from "./loader"

const ShippingOptionTypeDetail = () => {
  const { id } = useParams()
...
export const Component = ShippingOptionTypeDetail
