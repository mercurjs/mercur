...
export const promotionStatusMap: StatusMap = {
  [PromotionStatus.ACTIVE]: ["green", i18n.t("statuses.active") ?? "Active"],
  [PromotionStatus.INACTIVE]: ["red", i18n.t("statuses.inactive") ?? "Inactive"],
  [PromotionStatus.DRAFT]: ["grey", i18n.t("statuses.draft") ?? "Draft"],
  [PromotionStatus.SCHEDULED]: [
    "orange",
    `${i18n.t("promotions.fields.campaign") ?? "Campaign"} ${(i18n.t("statuses.scheduled") ?? "scheduled").toLowerCase()}`,
  ],
  [PromotionStatus.EXPIRED]: [
    "red",
    `${i18n.t("promotions.fields.campaign") ?? "Campaign"} ${(i18n.t("statuses.expired") ?? "expired").toLowerCase()}`,
  ],
}
