 ...
 * the cross-module dispatcher landed in SPEC-008 step 4 sub-step C
 ...
 *
 * **Gated on SPEC-008 step 5** — see sibling
...
if (STEP_5_LANDED) {
  ...
  describe.skip(
    "applyProductChangeActionsWorkflow per-action dispatch (SPEC-008 step 5 gated)",
    () => {
      it.skip(
